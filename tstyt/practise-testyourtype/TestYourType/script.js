const paragraphs = [
    ...
    "If you're reading these words, you're already on your way to reaching new heights! You've embarked on a journey where every step brings you closer to your goal. This text is your guide, your faithful companion on this exciting journey of self-discovery and achievement.",
...
function initTyping() {
    ...
    if (charIndex < characters.length - 1 && timeLeft > 0) {
        ...
        let wpm = Math.round(((charIndex - mistakes) / 5) / (maxTime - timeLeft) * 45);
